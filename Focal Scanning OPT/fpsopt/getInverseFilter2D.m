...
regFiltFFT1 = fftn((regFilt1), [N,N]); % regularization filter in FFT domain
regFiltFFT2 = fftn((regFilt2), [N,N]); % regularization filter in FFT domain
regFiltFFT3 = fftn((regFilt3), [N,N]); % regularization filter in FFT domain
regFiltFFT4 = fftn((regFilt4), [N,N]); % regularization filter in FFT domain
